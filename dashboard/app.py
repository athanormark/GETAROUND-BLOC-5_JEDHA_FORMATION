...
# Thème dark CSS cohérent avec l'API
st.markdown("""
<style>
...
# Template Plotly dark (cohérent avec le thème)
PLOTLY_LAYOUT = dict(
...
fig.update_yaxes(
    title_text="% cas résolus", secondary_y=False, gridcolor="#2a2d3a"
)
fig.update_yaxes(
    title_text="% locations bloquées", secondary_y=True, gridcolor="#2a2d3a"
)
st.plotly_chart(fig, use_container_width=True)
